...
@Deprecated
public final class PaperGameManagerOld {
    ...
    public void startGame(List<Player> playerList) {
        ...
        if (planeCollisionManager != null) {
            planeCollisionManager.cancel();
        }
        planeCollisionManager = new PlaneCollisionManager(this.plugin, this);
        planeCollisionManager.runTaskTimer(this.plugin, 0L, 1L);
...
//                    knight.setOwner(player.getUniqueId());
            ...
            PaperBlimpHealthManager blimpHealthManager = new PaperBlimpHealthManager(activeMobs);
...
//                    knight.setOwner(player.getUniqueId());
    ...
    public Map<String, PaperBlimpHealthManager> getHealthManager() {
    ...
    public void resetRoundState() {
        ...
        for (PaperBlimpHealthManager healthManager : runtime.getHealthManagers().values()) {
