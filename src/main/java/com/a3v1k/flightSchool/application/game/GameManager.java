...
public class GameManager {
    ...
    private FlightRunnable flightRunnable;
    ...
    public void startGame(List<Player> playerList) {
        ...
        if (flightRunnable != null) {
            flightRunnable.cancel();
        }
        flightRunnable = new FlightRunnable(this.plugin, this);
        flightRunnable.runTaskTimer(this.plugin, 0L, 1L);
